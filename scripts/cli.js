...
const contractABI = require("../artifacts/contracts/Acoustickite.sol/Acoustickite.json").abi;

program
    .name("acoustickite-cli")
    .description("CLI tool for Acoustickite smart contract")
    .version("1.0.0");
